...
<form action="studentserver.php?mn=2" method="POST">
    ...
    <fieldset id="submit-field">
      ...
      <br>
      <h6><a href="stsignup.php">Click here if not registered yet!</a></h6>
    </fieldset>
  </form>
