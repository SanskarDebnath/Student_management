...
<body style="width:75%; margin:20px">
...
<select id="branch" name="branch" required onchange="get_subjects()">
    ...
    <option value="Advanced Mechatronics & Industrial Automation">Advanced Mechatronics & Industrial Automation</option>
    <option value="Civil Engineering with Computer Application">Civil Engineering with Computer Application</option>
    <option value="Electrical and Computer Science Engineering">Electrical and Computer Science Engineering</option>
